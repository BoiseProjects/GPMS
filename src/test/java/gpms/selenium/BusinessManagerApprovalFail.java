...
public class BusinessManagerApprovalFail {
  ...
  public void testNewProposal() throws Exception {
    ...
    driver.findElement(By.id("txtProjectTitle")).sendKeys("Chair approval fail test4");
    ...
    driver.findElement(By.id("ui-id-21")).click();
    Thread.sleep(1000);
    driver.findElement(By.name("574620c6bcbb29150487642aBusiness_Manager")).click();
    Thread.sleep(1000);
    driver.findElement(By.name("574620c6bcbb29150487642aBusiness_Manager")).clear();
    Thread.sleep(1000);
    driver.findElement(By.name("574620c6bcbb29150487642aBusiness_Manager")).sendKeys("chair");
    Thread.sleep(1000);
