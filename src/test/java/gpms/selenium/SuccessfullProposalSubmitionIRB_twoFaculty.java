...
public class SuccessfullProposalSubmitionIRB_twoFaculty {
  ...
  public void testNewProposal() throws Exception {
    ...
    Thread.sleep(500);
    new Select(driver.findElement(By.id("ddlIRBOptions"))).selectByVisibleText("Pending");
    //Thread.sleep(1000);
  ...
  //Computer Science Business manager approval
    ...
    Thread.sleep(1000);
    driver.findElement(By.name("signaturedate5745f147bcbb29192ce0d40dBusiness_Manager")).click();
    Thread.sleep(1000);
    driver.findElement(By.xpath("//table[@id='trSignBusinessManager']/tbody/tr/td[3]")).click();
    Thread.sleep(1000);
    driver.findElement(By.id("btnApproveProposal")).click();
    ...
    driver.findElement(By.id("user_password")).sendKeys("gpmspassword");
    driver.findElement(By.id("user_email")).clear();
    driver.findElement(By.id("user_email")).sendKeys("irbcomputerscience@gmail.com");
    Thread.sleep(1000);
    driver.findElement(By.name("commit")).click();
    Thread.sleep(1000);
    driver.findElement(By.linkText("My Proposals")).click();
    ...
    Thread.sleep(1000);
    driver.findElement(By.name("5745fca7bcbb29192ce0d449IRB")).sendKeys("IRB");
    Thread.sleep(1000);
    driver.findElement(By.name("proposalNotes5745fca7bcbb29192ce0d449IRB")).clear();
    Thread.sleep(1000);
    driver.findElement(By.name("proposalNotes5745fca7bcbb29192ce0d449IRB")).sendKeys("Test");
    Thread.sleep(1000);
    driver.findElement(By.name("signaturedate5745fca7bcbb29192ce0d449IRB")).click();
    Thread.sleep(1000);
    driver.findElement(By.xpath("//table[@id='trSignIRB']/tbody/tr/td[3]")).click();
    Thread.sleep(1000);
    driver.findElement(By.id("btnApproveProposal")).click();
    Thread.sleep(1000);
    driver.findElement(By.id("BoxConfirmBtnOk")).click();
    ...
    driver.findElement(By.id("user_password")).sendKeys("gpmspassword");
    driver.findElement(By.id("user_email")).clear();
    driver.findElement(By.id("user_email")).sendKeys("irbelectricalengineering@gmail.com");
    driver.findElement(By.name("commit")).click();
    Thread.sleep(1000);
    driver.findElement(By.linkText("My Proposals")).click();
    Thread.sleep(1000);
    ...
    Thread.sleep(1000);
    driver.findElement(By.name("574604fabcbb29192ce0d46aIRB")).sendKeys("IRB");
    Thread.sleep(1000);
    driver.findElement(By.name("proposalNotes574604fabcbb29192ce0d46aIRB")).clear();
    Thread.sleep(1000);
    driver.findElement(By.name("proposalNotes574604fabcbb29192ce0d46aIRB")).sendKeys("Test");
    Thread.sleep(1000);
    driver.findElement(By.name("signaturedate574604fabcbb29192ce0d46aIRB")).click();
    Thread.sleep(1000);
    driver.findElement(By.xpath("//table[@id='trSignIRB']/tbody/tr[2]/td[3]")).click();
    Thread.sleep(1000);
    driver.findElement(By.id("btnApproveProposal")).click();
    Thread.sleep(1000);
    driver.findElement(By.id("BoxConfirmBtnOk")).click();
  ...
  //Computer science Dean approval
    driver.get(baseUrl + "GPMS/");
    driver.findElement(By.id("user_email")).clear();
    driver.findElement(By.id("user_email")).sendKeys("deancomputerscience@gmail.com");
    driver.findElement(By.id("user_password")).clear();
    driver.findElement(By.id("user_password")).sendKeys("gpmspassword");
    Thread.sleep(1000);
    driver.findElement(By.name("commit")).click();
    ...
    Thread.sleep(1000);
    driver.findElement(By.name("5745f5ebbcbb29192ce0d438Dean")).sendKeys("Dean");
    Thread.sleep(1000);
    driver.findElement(By.name("proposalNotes5745f5ebbcbb29192ce0d438Dean")).clear();
    Thread.sleep(1000);
    driver.findElement(By.name("proposalNotes5745f5ebbcbb29192ce0d438Dean")).sendKeys("Test");
    Thread.sleep(1000);
    driver.findElement(By.name("signaturedate5745f5ebbcbb29192ce0d438Dean")).click();
    Thread.sleep(1000);
    driver.findElement(By.xpath("//table[@id='trSignDean']/tbody/tr/td[3]")).click();
    Thread.sleep(1000);
    driver.findElement(By.id("btnApproveProposal")).click();
    ...
    Thread.sleep(1000);
    driver.findElement(By.name("5745fcfdbcbb29192ce0d451University_Research_Administrator")).sendKeys("Research");
    Thread.sleep(1000);
    ...
    Thread.sleep(1000);
    new Select(driver.findElement(By.id("ddlPISalaryIncluded"))).selectByVisibleText("Yes");
    Thread.sleep(1000);
    driver.findElement(By.cssSelector("#ddlPISalaryIncluded > option[value=\"1\"]")).click();
    Thread.sleep(1000);
    ...
    Thread.sleep(1000);
    driver.findElement(By.xpath("//div[@id='ui-id-24']/table/tbody/tr[13]/td[2]")).click();
    Thread.sleep(1000);
    driver.findElement(By.id("ddlInstitutionalCostDocumented")).click();
    Thread.sleep(1000);
    new Select(driver.findElement(By.id("ddlInstitutionalCostDocumented"))).selectByVisibleText("Yes");
    Thread.sleep(1000);
    driver.findElement(By.cssSelector("#ddlInstitutionalCostDocumented > option[value=\"1\"]")).click();
    Thread.sleep(1000);
    driver.findElement(By.id("ddlThirdPartyCostDocumented")).click();
    Thread.sleep(1000);
    new Select(driver.findElement(By.id("ddlThirdPartyCostDocumented"))).selectByVisibleText("Yes");
    Thread.sleep(1000);
    driver.findElement(By.cssSelector("#ddlThirdPartyCostDocumented > option[value=\"1\"]")).click();
    Thread.sleep(1000);
    driver.findElement(By.id("ddlPIEligibilityWaiver")).click();
    Thread.sleep(1000);
    new Select(driver.findElement(By.id("ddlPIEligibilityWaiver"))).selectByVisibleText("Yes");
    Thread.sleep(1000);
    driver.findElement(By.cssSelector("#ddlPIEligibilityWaiver > option[value=\"1\"]")).click();
    Thread.sleep(1000);
    driver.findElement(By.id("ddlCOIForms")).click();
    Thread.sleep(1000);
    new Select(driver.findElement(By.id("ddlCOIForms"))).selectByVisibleText("No");
    Thread.sleep(1000);
    driver.findElement(By.cssSelector("#ddlCOIForms > option[value=\"2\"]")).click();
    Thread.sleep(1000);
    driver.findElement(By.id("ddlCOIForms")).click();
    Thread.sleep(1000);
    new Select(driver.findElement(By.id("ddlCOIForms"))).selectByVisibleText("Yes");
    Thread.sleep(1000);
    driver.findElement(By.cssSelector("#ddlCOIForms > option[value=\"1\"]")).click();
    Thread.sleep(1000);
    driver.findElement(By.id("ddlCheckedExcludedPartyList")).click();
    Thread.sleep(1000);
    new Select(driver.findElement(By.id("ddlCheckedExcludedPartyList"))).selectByVisibleText("Yes");
    Thread.sleep(1000);
    driver.findElement(By.cssSelector("#ddlCheckedExcludedPartyList > option[value=\"1\"]")).click();
    Thread.sleep(1000);
    driver.findElement(By.id("btnApproveProposal")).click();
    Thread.sleep(1000);
    driver.findElement(By.id("BoxConfirmBtnOk")).click();
    ...
    driver.findElement(By.id("lblSection11")).click();
    Thread.sleep(1000);
    driver.findElement(By.name("5745fd43bcbb29192ce0d459University_Research_Director")).clear();
    Thread.sleep(1000);
    driver.findElement(By.name("5745fd43bcbb29192ce0d459University_Research_Director")).sendKeys("Director");
    Thread.sleep(1000);
    driver.findElement(By.name("proposalNotes5745fd43bcbb29192ce0d459University_Research_Director")).clear();
    Thread.sleep(1000);
    driver.findElement(By.name("proposalNotes5745fd43bcbb29192ce0d459University_Research_Director")).sendKeys("Test");
    Thread.sleep(1000);
    driver.findElement(By.name("signaturedate5745fd43bcbb29192ce0d459University_Research_Director")).click();
    Thread.sleep(1000);
    driver.findElement(By.xpath("//table[@id='trSignDirector']/tbody/tr/td[3]")).click();
    Thread.sleep(1000);
