...
/* DeanApprovalFailure
 * Made By: Nick
 * Dean attempts to approve a proposal that has not been submitted by PI yet.Program will close and throw an invalid element state
...
public class DeanApprovalFail {
  ...
  public void testNewProposal() throws Exception {
    ...
    driver.findElement(By.id("txtProjectTitle")).sendKeys("Dean approval Fail2");
    ...
    driver.findElement(By.id("ui-id-21")).click();
    Thread.sleep(1000);
    driver.findElement(By.name("57460657bcbb29192ce0d483Dean")).click();
    Thread.sleep(1000);
