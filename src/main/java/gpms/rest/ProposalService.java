...
public class ProposalService {
	...
	public String saveUpdateProposal(String message)
		...
		HashMap<String, Multimap<String, String>> attrPolicyMap = new HashMap<String, Multimap<String, String>>();
		...
		for (JsonNode jsonNode : policyInfo) {

			if (jsonNode != null && jsonNode.has("attributeType")) {
				attributeType = jsonNode.get("attributeType").getTextValue();
				switch (attributeType) {
				case "Subject":
					if (jsonNode != null && jsonNode.has("attributeName")) {
						attributeName = jsonNode.get("attributeName")
								.getTextValue();
					} else if (jsonNode != null
							&& jsonNode.has("attributeValue")) {
						attributeValue = jsonNode.get("attributeValue")
								.getTextValue();
					}
		...
		attrPolicyMap.put("Subject", subjectMap);
		attrPolicyMap.put("Resource", resourceMap);
		attrPolicyMap.put("Action", actionMap);
