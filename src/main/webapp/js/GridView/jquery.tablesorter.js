 ...
 *       in ascending order.
 * 
 * @example $('table').tablesorter({ headers: { 0: { sorter: false}, 1: {sorter:
 *          false} } });
					...
					this.construct = function(settings) {
						...
						return this
								.each(function() {
									...
									// try to auto detect column type, and store
									// in tables config
									...
									// get the css class names, could be done
									// else where.
									...
									// apply easy methods that trigger binded
									// events
									$this
											.bind(
													"update",
									...
									// if user has supplied a sort list to
									// constructor.
