...
(function(factory) {
	if (typeof define === "function" && define.amd) {
		...
		(function($) {
			...
			/*
			 * Dutch bank account numbers (not 'giro' numbers) have 9 digits and
			 * pass the '11 check'. We accept the notation with spaces, as that
			 * is common. acceptable: 123456789 or 12 34 56 789
			 */
			...
			/**
			 * BIC is the business identifier code (ISO 9362). This BIC check is
			 * not a guarantee for authenticity.
			 * 
			 * BIC pattern: BBBBCCLLbbb (8 or 11 characters long; bbb is
			 * optional)
			 * 
			 * BIC definition in detail: - First 4 characters - bank code (only
			 * letters) - Next 2 characters - ISO 3166-1 alpha-2 country code
			 * (only letters) - Next 2 characters - location code (letters and
			 * digits) a. shall not start with '0' or '1' b. second character
			 * must be a letter ('O' is not allowed) or one of the following
			 * digits ('0' for test (therefore not allowed), '1' for passive
			 * participant and '2' for active participant) - Last 3 characters -
			 * branch code, optional (shall not start with 'X' except in case of
			...
			/*
			 * Código de identificación fiscal ( CIF ) is the tax identification
			 * code for Spanish legal entities Further rules can be found in
			 * Spanish on
			...
			$.validator
					.addMethod(
							...
							function(value) {
								...
								/*
								 * The first (position 1) is a letter following
								 * the following criteria: A. Corporations B.
								 * LLCs C. General partnerships D. Companies
								 * limited partnerships E. Communities of goods
								 * F. Cooperative Societies G. Associations H.
								 * Communities of homeowners in horizontal
								 * property regime J. Civil Societies K. Old
								 * format L. Old format M. Old format N.
								 * Nonresident entities P. Local authorities Q.
								 * Autonomous bodies, state or not, and the
								 * like, and congregations and religious
								 * institutions R. Congregations and religious
								 * institutions (since 2008 ORDER EHA/451/2008)
								 * S. Organs of State Administration and regions
								 * V. Agrarian Transformation W. Permanent
								 * establishments of non-resident in Spain
								 */
			...
			/*
			 * Brazillian CPF number (Cadastrado de Pessoas Físicas) is the
			 * equivalent of a Brazilian tax registration number. CPF numbers
			 * have 11 digits in total: 9 numbers followed by 2 check numbers
			...
			$.validator.addMethod("cpfBR", function(value) {
				...
				// If first Check Number (CN) is valid, move to Step 2 - using
				// second Check Number:
			...
			/**
			 * IBAN is the international bank account number. It has a country -
			 * specific format, that is checked here too
			 */
			$.validator
					.addMethod(
							"iban",
							function(value, element) {
								// some quick simple tests to prevent needless
								// work
								if (this.optional(element)) {
									return true;
								}
								...
								// check the country code and find the country
								// specific format
								...
								// future, we only check if the countrycode is
								// known.
								// This prevents false negatives, while almost
								// all
								// false positives introduced by this, will be
								// caught
								// by the checksum validation below anyway.
								// Strict checking should return FALSE for
								// unknown
								// countries.
								...
								// now check the checksum, first convert to
								// digits
			 ...
			 * Extract $1 and set $prefix to '+44<space>' if $1 is '44',
			 * otherwise set $prefix to '0' Extract $2 and remove hyphens,
			 * spaces and parentheses. Phone number is combined $prefix and $2.
			 * A number of very detailed GB telephone number RegEx patterns can
			 * also be found at:
			...
			/*
			 * The número de identidad de extranjero ( NIE )is a code used to
			 * identify the non-nationals in Spain
			 */
			$.validator
					.addMethod(
							"nieES",
			...
			/*
			 * The Número de Identificación Fiscal ( NIF ) is the way tax
			 ...
			 * 
			 * where the area code may not start with 1 and the prefix may not
			 * start with 1 allows '-' or ' ' as a separator and allows parens
			 * around area code some people may want to put a '1' in front of
			 * their number
			 * 
			 ...
			 * http://www.aa-asterisk.org.uk/index.php/Regular_Expressions_for_Validating_and_Formatting_GB_Telephone_Numbers
			 */
			// Matches UK landline + mobile, accepting only 01-3 for landline or
			// 07 for mobile to exclude many premium numbers
			$.validator
					.addMethod(
							"phonesUK",
							function(phone_number, element) {
			 ...
			 * 
			 * @example jQuery.validator.methods.postalCodeCA( "H0H 0H0",
			 *          element )
			 * @result true
			 * 
			 ...
			 * 
			 * Formatos aceitos: 99999-999 99.999-999 99999999
			 */
			...
			// Matches UK postcode. Does not match to UK Channel Islands that
			// have their own postcodes (non standard UK)
			$.validator
					.addMethod(
							"postcodeUK",
							function(value, element) {
