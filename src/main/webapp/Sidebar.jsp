			...
			<li class="Grandparent sfLevel0 active" style="display: block;"><a
				...
				<ul style="display: none" class="acitem">
					<li class="parent sfLevel1 active"><a href="#"><i
						...
						<ul style="display: none" class="acitem">
							<li class="child sfLevel2"><a href="/aspx/Admin/Users.jsp"
								class="active"><i class="icon-arrow-slim-e"></i><span>Users</span></a></li>
							<li class="child sfLevel2"><a href="/aspx/Admin/Roles.jsp"><i
					...
					<li class="parent sfLevel1"><a href="#"><i
						...
						<ul style="display: none" class="acitem">
							<li class="child sfLevel2"><a href="/aspx/Admin/Pages.jsp"><i
					...
					<li class="parent sfLevel1"><a href="#"><i
						...
						<ul style="display: none" class="acitem">
							<li class="child sfLevel2"><a
								href="/aspx/Admin/Settings.jsp"><i class="icon-arrow-slim-e"></i><span>Portal
										Settings</span></a></li>
						</ul></li>
				</ul></li>
		</ul>
